(function (cp) {
  cp.generateNewQuestion = () => {
    ...
    reaction[47] = "";
    factors[47] = new dataset();
    react[47] = new compound();
    products[47] = new compound();
    reaction[48] = "";
    factors[48] = new dataset();
    react[48] = new compound();
    products[48] = new compound();
    reaction[49] = "";
    factors[49] = new dataset();
    react[49] = new compound();
    products[49] = new compound();
    reaction[50] = "";
    factors[50] = new dataset();
    react[50] = new compound();
    products[50] = new compound();
    reaction[51] = "";
    factors[51] = new dataset();
    react[51] = new compound();
    products[51] = new compound();
    reaction[52] = "";
    factors[52] = new dataset();
    react[52] = new compound();
    products[52] = new compound();
    reaction[53] = "";
    factors[53] = new dataset();
    react[53] = new compound();
    products[53] = new compound();
    reaction[54] = "";
    factors[54] = new dataset();
    react[54] = new compound();
    products[54] = new compound();
    reaction[55] = "";
    factors[55] = new dataset();
    react[55] = new compound();
    products[55] = new compound();
    reaction[56] = "";
    factors[56] = new dataset();
    react[56] = new compound();
    products[56] = new compound();
    reaction[57] = "";
    factors[57] = new dataset();
    react[57] = new compound();
    products[57] = new compound();
    reaction[58] = "";
    factors[58] = new dataset();
    react[58] = new compound();
    products[58] = new compound();
    reaction[59] = "";
    factors[59] = new dataset();
    react[59] = new compound();
    products[59] = new compound();
    reaction[60] = "";
    factors[60] = new dataset();
    react[60] = new compound();
    products[60] = new compound();
    reaction[61] = "";
    factors[61] = new dataset();
    react[61] = new compound();
    products[61] = new compound();
    reaction[62] = "";
    factors[62] = new dataset();
    react[62] = new compound();
    products[62] = new compound();
    reaction[63] = "";
    factors[63] = new dataset();
    react[63] = new compound();
    products[63] = new compound();
    reaction[64] = "";
    factors[64] = new dataset();
    react[64] = new compound();
    products[64] = new compound();
    reaction[65] = "";
    factors[65] = new dataset();
    react[65] = new compound();
    products[65] = new compound();
    reaction[66] = "";
    factors[66] = new dataset();
    react[66] = new compound();
    products[66] = new compound();
    reaction[67] = "";
    factors[67] = new dataset();
    react[67] = new compound();
    products[67] = new compound();
    reaction[68] = "";
    factors[68] = new dataset();
    react[68] = new compound();
    products[68] = new compound();
    reaction[69] = "";
    factors[69] = new dataset();
    react[69] = new compound();
    products[69] = new compound();
    reaction[70] = "";
    factors[70] = new dataset();
    react[70] = new compound();
    products[70] = new compound();

    //begin concentrations
    let basequest = new question(
      "If the reaction:<br>",
      "<br>is at equilibirum with the K and concentrations as shown, what is the concentration of ",
      "?<br>"
    );
    ...
    function begin() {
      ...
      //end K calculation
      getunknown(which);
      concseries(which, unknown, reactnum, prodnum);
      let quest =
        basequest["p1"] +
        reaction[which] +
        basequest["p2"] +
    ...
    function getunknown(which) {
      let unk, s;
      if (Math.random() < 0.5) {
        unk = Math.ceil(react[which]["n"] * Math.random());
        s = "c" + unk;
        unknown = react[which][s];
        theanswer = reactconc[unk];
      } else {
        unk = Math.ceil(products[which]["n"] * Math.random());
        s = "c" + unk;
        unknown = products[which][s];
        theanswer = prodconc[unk];
      }
      return unknown;
    }
    function concseries(which, unknown, nr, np) {
      series = "Equilibrium Concentrations:<br>";
      for (j = 1; j <= nr; j++) {
        if (react[which]["c" + j] != unknown) {
          series =
            series +
            "[" +
            react[which]["c" + j] +
